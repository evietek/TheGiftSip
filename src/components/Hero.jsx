...
// Load Poppins for your description
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative max-w-md space-y-8 2xl:ml-24 lg:ml-12 ml-0">
            {/* Decorative arrow */}
            <FiArrowUpRight className="absolute 2xl:top-54 lg:top-40 top-32 left-0 2xl:text-3xl lg:text-2xl text-xl text-[#12161D]" />

            {/* Insight pill */}
            <div className="inline-block border border-orange-500 bg-white text-orange-500 px-4 py-2 rounded-full text-sm font-medium">
              Insight Beyond
            </div>

            {/* Heading with Luckiest Guy font and correct slashes */}
            <h1 className={`${luckiest.className} 2xl:text-[96px] xl:text-[72px] lg:text-[64px] md:text-[56px] sm:text-[48px] text-[40px] text-[#12161D] leading-none`}> 
              STYLE<span className="text-[#8A38EE]">/</span><br />
              <span className="text-[#8A38EE] 2xl:ml-24 xl:ml-18 lg:ml-16 md:ml-14 sm:ml-12 ml-10">/</span><span className="italic text-[#12161D]">FASHION</span><br />
              TREND<span className="text-[#8A38EE]">/</span>
            </h1>

            {/* Subtitle */}
           <p className={`${poppins.className} text-gray-600 2xl:text-lg xl:text-base lg:text-base md:text-base sm:text-sm text-sm max-w-md leading-relaxed 2xl:ml-16 lg:ml-12 ml-0`}>
           Wear your vibe, sip your story.<br/>
           Discover unique graphic tees and funny mugs
           designed for memorable sips and daily smiles.
            </p>

            {/* Search field */}
            <form onSubmit={handleSearch} className="flex items-center mt-6 w-full max-w-md rounded-full overflow-hidden border border-gray-300 bg-white shadow-sm 2xl:ml-16 lg:ml-12 ml-0 focus-within:ring-2 focus-within:ring-orange-500">
              <button 
                type="submit"
              ...
              >
                ...
                <span className="ml-2 flex items-center justify-center 2xl:w-6 2xl:h-6 lg:w-5 lg:h-5 w-4 h-4 border border-white rounded-full">
                  <FiSearch className="text-white 2xl:text-sm lg:text-xs text-xs" />
                </span>
              </button>
